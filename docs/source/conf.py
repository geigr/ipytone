...
# -*- coding: utf-8 -*-
#
# ipytone documentation build configuration file
#
...
latex_documents = [
    (master_doc, "ipytone.tex", "ipytone Documentation", "Benoit Bovy", "manual"),
]
...
man_pages = [(master_doc, "ipytone", "ipytone Documentation", [author], 1)]
